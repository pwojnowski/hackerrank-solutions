...
public class DiGraphAdjacencyLists implements Graph {

    private final Collection<Integer>[] vertices;
    private int edgeCount;

    private DiGraphAdjacencyLists(Collection<Integer>[] vertices) {
        this.vertices = vertices;
    }

    public static Graph create(int v) {
        @SuppressWarnings("unchecked")
        DiGraphAdjacencyLists g = new DiGraphAdjacencyLists(new List[v]);
    ...
    public boolean equals(Object o) {
        ...
        DiGraphAdjacencyLists graph = (DiGraphAdjacencyLists) o;
